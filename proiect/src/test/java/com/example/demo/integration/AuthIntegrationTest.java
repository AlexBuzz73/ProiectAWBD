...
public class AuthIntegrationTest {
    ...
    void shouldRegisterAndLoginSuccessfully() throws Exception {
        ...
        User savedUser =
                userRepository.findByEmail("alex@test.com").orElseThrow();
    ...
    @Test
    void shouldBlockUserAfterThreeFailedLoginsThenUnlockAndLoginSuccessfully()
            throws Exception {
    ...
    @Test
    void shouldReturnBadRequestWhenRegisterDataIsInvalid()
            throws Exception {
