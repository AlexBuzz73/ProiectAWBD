...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        log.warn("Validation error on account-service: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleIllegalArgument(IllegalArgumentException ex) {
        log.warn("Illegal argument on account-service: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleIllegalState(IllegalStateException ex) {
        log.warn("Illegal state on account-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
        body.put("error", ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(body);
    }
    ...
    public ResponseEntity<Map<String, String>> handleBadRequestExceptions(Exception ex) {
        log.warn("Bad request on account-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
    ...
    public ResponseEntity<Map<String, String>> handleNotFoundExceptions(Exception ex) {
        log.warn("Resource not found on account-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
    ...
    public ResponseEntity<Map<String, String>> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
        log.warn("HTTP method not supported on account-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
    ...
    public ResponseEntity<Map<String, String>> handleAccessDenied(AccessDeniedException ex) {
        log.warn("Access denied on account-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
    ...
    public ResponseEntity<Map<String, String>> handleAuthenticationException(AuthenticationException ex) {
        log.warn("Authentication error on account-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
