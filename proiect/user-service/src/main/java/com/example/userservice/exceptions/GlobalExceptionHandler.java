...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleValidationExceptions(MethodArgumentNotValidException ex) {
        log.warn("Validation error on user-service: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleIllegalArgument(IllegalArgumentException ex) {
        log.warn("Illegal argument on user-service: {}", ex.getMessage());
    ...
    public ResponseEntity<Map<String, String>> handleBadRequestExceptions(Exception ex) {
        log.warn("Bad request on user-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
    ...
    public ResponseEntity<Map<String, String>> handleNotFoundExceptions(Exception ex) {
        log.warn("Resource not found on user-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
        body.put("error", "Resursa nu a fost gasita");
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(body);
    }

    @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
    public ResponseEntity<Map<String, String>> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
        log.warn("HTTP method not supported on user-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
    ...
    public ResponseEntity<Map<String, String>> handleAccessDenied(AccessDeniedException ex) {
        log.warn("Access denied on user-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
        body.put("error", "Acces interzis");
        return ResponseEntity.status(HttpStatus.FORBIDDEN).body(body);
    }

    @ExceptionHandler(AuthenticationException.class)
    public ResponseEntity<Map<String, String>> handleAuthenticationException(AuthenticationException ex) {
        log.warn("Authentication error on user-service: {}", ex.getMessage());
        Map<String, String> body = new HashMap<>();
